...
class FormEnregistrement extends FormBase {
  ...
  public function buildForm(array $form, FormstateInterface $form_state) {
    ...
    $form['firstname'] = [
      ...
      '#maxlength' => 20,
      '#title' => $this->t('Nom'),
      '#description' => $this->t("Entrer votre Nom "),
      '#required' => TRUE,
    ...
    $form['lastname'] = [
      ...
      '#maxlength' => 20,
      '#title' => $this->t('Prénom'),
      '#description' => $this->t('Entrer votre prénom'),
      '#required' => TRUE,
    ];
    ...
    $form['birth_date'] = [
      ...
      '#description' => $this->t('Entrer votre date de naissance '),
      '#required' => TRUE,
    ];
    ...
    $form['adress'] = [
      ...
      '#description' => $this->t('Entrer le nom de la voie'),
      '#required' => TRUE,
    ];
